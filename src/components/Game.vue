<template>
  <div class="game">
    <div class="game-container">
      ...
      <div v-if="game.step == 'guess' && !game.winner" class="timer">
        {{ timer }}
      </div>
      ...
      <p v-if="!game.winner">
        <span v-if="game.userTurn != user.username">
          <span v-if="game.round > 1">Nice moves. </span>Waiting on
          {{ challenger.username }} ...</span
        >

        <span v-else>
          <span v-if="game.step == 'listen'"
            >{{ challenger.username }} has made a move.</span
          >
      ...
      <transition name="gameover">
        <div v-if="game.winner">
          <h5 v-if="game.winner == challenger.username" class="gameover">
            GAMEOVER
          </h5>
      ...
      <!-- TEMP AI ACTIONS -->
      <button
        v-if="game.userTurn == challenger.username && !game.winner"
        class="btn ai"
        @click="aiMove()"
      >
        AI MOVE
